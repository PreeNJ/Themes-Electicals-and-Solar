...
export const SOLAR_PRODUCTS: Product[] = [
  ...
  // - jinko-620w-bifacial
  // - jinko-625w-bifacial
  // - ja-solar-620w-bifacial
  // - trina-solar-620w-vertex

  // 2. HUAWEI SMART INVERTERS
  // - huawei-5kw-smart-inverter (SUN2000-5KTL-L1)
  // - huawei-10kw-3phase-inverter (SUN2000-10KTL-M1)

  // 3. SOSEN OFF-GRID INVERTERS (Preserving handwritten specs)
  // - sosen-3.6kw-offgrid (3.6 kW — Off-Grid)
  // - sosen-5.5kw-offgrid (5 kW → 5.5 kW — Off-Grid)
  // - sosen-6kw-offgrid (6 kW — Off-Grid)

  // 4. SOSEN 3-PHASE HYBRID COMMERCIAL INVERTERS
  // - sosen-12kw-hybrid-3phase
  // - sosen-15kw-hybrid-3phase
  // - sosen-20kw-hybrid-3phase
  // - sosen-30kw-hybrid-3phase
  // - sosen-40kw-hybrid-3phase
  // - sosen-50kw-hybrid-3phase
  // - sosen-60kw-hybrid-3phase

  // 5. DEYE HYBRID SMART INVERTERS
  // - deye-5kw-hybrid-inverter
  // - deye-8kw-hybrid-inverter
  // - deye-10kw-3phase-hybrid
  // - deye-12kw-3phase-hybrid
