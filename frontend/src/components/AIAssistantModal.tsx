  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      sender: 'assistant',
      text: `Hello! Jambo! 👋 I am your Senior Electrical & Solar Systems Engineer at **Themes Electricals**.
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-sm text-white">Themes Electricals AI Engineer</span>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 bg-slate-50 text-xs text-slate-800">
          ...
          {isLoading && (
            <div className="flex gap-2.5 items-start">
              <div className="w-7 h-7 rounded-lg bg-blue-950 text-red-400 flex items-center justify-center">
