...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs" id="main-header">
      {/* Top Announcement Bar - Red & Blue Signature */}
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 text-blue-100">
            <a 
              ...
              className="flex items-center gap-1.5 hover:text-white transition-colors bg-blue-800/80 px-2 py-0.5 rounded"
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              id="brand-logo-btn"
            >
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-700 via-blue-800 to-red-600 flex items-center justify-center text-white shadow-md ring-2 ring-blue-100 group-hover:scale-105 transition-transform">
                <Zap className="w-6 h-6 text-white fill-amber-300 stroke-[2.2]" />
              </div>
              <div>
                <div className="flex items-center gap-1">
                  <span className="font-extrabold text-2xl tracking-tight text-blue-900">Themes</span>
                  <span className="font-bold text-2xl tracking-tight text-red-600">Electricals</span>
                </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 bg-slate-50 hover:bg-blue-50 text-blue-900 rounded-lg text-xs font-bold border border-blue-200 hover:border-blue-300 transition-colors"
              id="quote-header-btn"
            >
            ...
            {/* Cart Button with count inside ShoppingBag icon and product count */}
            <button
              onClick={onOpenCart}
              className="relative flex items-center gap-2 px-3.5 py-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl text-xs shadow-md hover:shadow-lg transition-all focus:outline-hidden"
              id="cart-header-btn"
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                {cartItemCount > 0 && (
                  <span className="hidden sm:inline text-[11px] font-semibold text-red-100 bg-red-800/60 px-1.5 py-0.5 rounded">
      ...
      {/* Navigation Sub-Bar (Navy Blue with Red Accents) */}
      <nav className="bg-slate-900 text-slate-200 text-xs font-medium border-t border-slate-800" id="main-nav-bar">
          ...
          <div className="flex items-center justify-between overflow-x-auto py-1 scrollbar-none gap-2">
            ...
            <div className="hidden lg:flex items-center gap-3 shrink-0">
              ...
              >
                ...
                <span>Need Technical Advice? Ask AI</span>
              </button>
            </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-900 border-b border-slate-800 px-4 py-4 space-y-2 text-slate-200">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2.5 rounded-lg bg-slate-800 text-white font-semibold text-xs flex items-center justify-between"
          >
          ...
          <button
            ...
            className="w-full text-left px-3 py-2.5 rounded-lg bg-slate-800 text-slate-200 font-medium text-xs flex items-center justify-between"
          >
          ...
          <div className="pt-2 border-t border-slate-800 flex gap-2">
            ...
            <button
              ...
              className="flex-1 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg text-xs flex items-center justify-center gap-1 shadow-md"
            >
